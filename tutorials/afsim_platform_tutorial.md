...
```
// scenarios/red_laydown.txt 或 blue_laydown.txtplatform ship SHIP    
position 30:23:20.040n 80:55:06.960w    side red    icon carrier​    
route // 航线定义开始        
// 航点 0 (起点, 可定义标签方便跳转)        
label Start         
...
end_route // 航线定义结束 end_platform afsim
```
